rule win_deltas_g0 {
    meta:
        ...
        sample = "c18f39829759ffd0f51fb2224a57469e16e7bb542ec31ab94be1cf8222f7a23d"
    ...
    strings: 
        ...
        $plain_strings_1 = "CheckHost"
        $plain_strings_2 = "TestHost"

    condition:
       $ciphersuites and (all of ($plain_strings_*))
}
