...
cape_diplicated=["Arkei.yar", "Adzok.yar", "T5000.yar", "CyberGate.yar", "ShadowTech.yar", "xRAT.yar"]

no_use = ["MALW_CAP_Win32Inet.yara", "MALW_LURK0.yar", "MALW_Surtr.yar", "RAT_Bolonyokte.yar", "MALW_Glasses.yar", "MALW_IcedID.yar", "Kovter.yar", "Xtreme.yar", "BlackShades.yar", "Bozok.yar", "NetTraveler.yar"]
