...
ignore = ["general_cloaking.yar", "yara_mixed_ext_vars.yar", "generic_anomalies.yar", "thor_inverse_matches.yar", "MALW_Httpsd_ELF.yar", "MALW_AZORULT.yar","MALW_Torte_ELF.yar", "MALW_Mirai_Okiru_ELF.yar", "MALW_Mirai_Satori_ELF.yar", "MALW_TinyShell_Backdoor_gen.yar"]
...
def find_signatures(root):
        ...
        for entry in os.listdir(root):
            if entry.endswith(".yara") or entry.endswith(".yar") and entry not in ignore and entry not in duplicated:
